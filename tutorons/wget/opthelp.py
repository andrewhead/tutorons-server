...
COMBOHELP = {
    ('--recursive', '--level', '--accept'): "This command recursively scrapes web pages with the extension '{accept}' from {url}, following links {level} time{{levelp}}.",
    ('--user', '--password'): "This command authenticates with username '{user}' and password '{password} before fetching content'.",
    ('--recursive', '--level'): "This command recursively scrapes web pages from {url}, following links {level} time{{levelp}}.",
    ('--recursive', '--accept'): "This command recursively scrapes web pages with the extension '{accept}' from {url}.",
}


# Help messages scraped from wget source.
OPTHELP = \
(
